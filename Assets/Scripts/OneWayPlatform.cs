...
public class OneWayPlatform : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 triggerScale = new Vector3(5f, 5f, 1f);
    ...
    /// <summary>
    /// Created a one way platform in Unity 3D
    /// </summary>
    ...
    */
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        // Get the position and rotation of the transform
        Gizmos.color = Color.blue;
        Gizmos.DrawCube(collider.bounds.center, triggerScale);
